...
const data = [
  ...
  {
    id: 2,
    label: 'Integrated Efficiency.',
  },
  {
    id: 3,
    label: 'Guided digital instructions',
  },
  {
    id: 4,
    label: 'Predefined test procedures',
  },
  {
    id: 5,
        ...
        <Grid sx={styles.grid}>
          <Box sx={styles.rightContent}>
            <SectionHeading
              ...
              description="Twinmo: Elevating innovation, testing, and quality control for kitchen appliances, personal care products, and home furniture"
            />
